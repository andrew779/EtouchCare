...
public class AddSympton extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_sympton);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AddSympton.this, "Adding", Toast.LENGTH_SHORT).show();
                ...
                test.setDescription(txtdescription.getText().toString());
                ...
                utils.addCondition(AddSympton.this,json);
